...
const UserProfile: React.FC<UserProfileProps> = ({user}) => {
  ...
  return (
    <>
    {
       user !== null ? (<div className={styles.wrapper}>
          <header>
          ...
          <div className={styles.content}>
            ...
            <Input isDisabled={isDisabled} inputName='Username' content={user.username} type='text'/>
            <Input isDisabled={isDisabled} inputName='E-mail' content={user.email} type='email'/>
            <Input isDisabled={isDisabled} inputName='Street' content={user.address.street} type='text'/>
            <Input isDisabled={isDisabled} inputName='City' content={user.address.city} type='text'/>
            <Input isDisabled={isDisabled} inputName='Zipcode' content={user.address.zipcode} type='text'/>
